cp /var/mtlfe/dispatch/config/upstart/mtlfe-server-8001.conf /etc/init/mtlfe.conf
cp /var/mtlfe/dispatch/config/upstart/mtlfe-server-8002.conf /etc/init/mtlfe.conf
cp /var/mtlfe/dispatch/config/upstart/mtlfe-server-8003.conf /etc/init/mtlfe.conf
cp /var/mtlfe/dispatch/config/upstart/mtlfe-hook-9001.conf   /etc/init/mtlfe.conf
